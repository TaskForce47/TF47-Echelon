...
void intercept::pre_start() {
    ...
    auto cmd_createSession = intercept::client::host::register_sqf_command("tf47createSession", "creates a new session in the database", createSession, game_data_type::STRING);
    auto cmd_stopSession = intercept::client::host::register_sqf_command("tf47stopsession", "Stops a session", endSession, game_data_type::STRING);
    auto cmd_updateClient = intercept::client::host::register_sqf_command("tf47updateClient", "Updating a playername and connection in the database", updateClient, game_data_type::STRING, game_data_type::ARRAY);
